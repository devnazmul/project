  ...
  return (
    <div className=" bg-gradient-to-l from-[#83e9fb] to-[#f591d2] px-5 py-5 md:px-10 md:py-10">
      <div className=" backdrop-filter-blur bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-50 border border-white  rounded-3xl overflow-hidden w-full  text-slate-200 relative">
        ...
        />
        {/* HEADER  */}
        <div className="md:h-[170px] flex flex-col align-middle justify-between py-5 px-5 xl:px-36 servicePageNav">
          <div className="flex justify-center items-center">
            <ServiceLink to={"/"} icon={image1} text={"General Service"} />
            <ServiceLink to={"/"} icon={image3} text={"Engine Work"} />
            <ServiceLink to={"/"} icon={image4} text={"Body Work"} />
            <ServiceLink to={"/"} icon={image2} text={"Repair Work"} />
          </div>
        </div>
        {/* HEADER SECTION  */}
            ...
            {Array.from({ length: 10 }, (_, index) => (
              ...
              >
                ...
                <div className="servCard flex flex-col justify-between h-[320px]  w-[700px]">
                  ...
                  <p className="px-7 py-1">Any other additional problem with be reported post vehicle inspection</p>
                  <div className="servFooter h-[100px] flex justify-between items-center px-10">
                    ...
                    <div className="servBtuuon flex flex-col">
                        ...
                        <span className="text-black text-sm mt-2">Click to Add</span>
                    </div>
                  </div>
